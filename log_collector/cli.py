...
class CLI:
    ...
    def _view_live_status(self):
        """View live system and sources status in a continuously updating display."""
        if not curses:
            print(f"{Fore.RED}Curses library not available. Cannot display live status.{ColorStyle.RESET_ALL}")
            input("Press Enter to continue...")
            return
